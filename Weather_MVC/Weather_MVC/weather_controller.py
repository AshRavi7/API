...
def GetChoice():
    ...
    # fixed the conflict by accepting the changes from the test branch- human intervention required. 
    print(msg)
...
def GetLocation():
    location=input(weather_view.LocationView()) # blr 
...
# debug,info,error,warning and critical 